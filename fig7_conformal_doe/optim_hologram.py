...
HOW TO RUN:
  python -m fig7_conformal_doe.optim_hologram
  python -m fig7_conformal_doe.optim_hologram --config-dir configs/fig7_hologram
"""
...
DEFAULT_HOLOGRAM_CONFIG = "fig7_hologram"
