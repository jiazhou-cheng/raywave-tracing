"""
MetaGSL (Generalized Snell's Law) diffractive surface implementation based on Aspheric class.
Put it under deeplens/optics/diffractive_surface/metaGSL.py. 
"""
...
class AsphericMetaGSL(Aspheric):
    """
    ...
    def init_from_dict(cls, surf_dict):
        """Initialize AsphericMetaGSL from a dict."""
        d = surf_dict["d"]
    ...
    def surf_dict(self):
        ...
        surf_dict.update({"type": "AsphericMetaGSL"})
        return surf_dict
